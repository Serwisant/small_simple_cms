<script setup>
    ...
    `
        },
        {
            ...
            <div class="row">
                <div class="col-lg-6 col-12 mb-3">
                    <img src="src/assets/portrait-mature-smiling-authoress-sitting-desk.jpg" class="scrollspy-example-item-image img-fluid" alt="">
                </div>

                <div class="col-lg-6 col-12 mb-3">
                    <img src="src/assets/businessman-sitting-by-table-cafe.jpg" class="scrollspy-example-item-image img-fluid" alt="">
                </div>
            </div>
        ...
        },
        {
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-12">
                    <img src="src/assets/tablet-screen-contents.jpg" class="img-fluid" alt="">
                </div>
        ...
        },
        {
            ...
            <img src="src/assets/portrait-mature-smiling-authoress-sitting-desk.jpg" class="scrollspy-example-item-image img-fluid mb-3" alt="">
    ...
    onMounted(async () => {
        const postsResponse = await mockUpResponse();
